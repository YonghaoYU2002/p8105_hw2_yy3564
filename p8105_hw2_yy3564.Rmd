...
`r sum(filter(combined_df, which_trash_wheel == "Professor Trash Wheel")$weight_tons[1:(length(filter(combined_df, which_trash_wheel == "Professor Trash Wheel")$weight_tons) - 1)], na.rm = TRUE)` tons.
